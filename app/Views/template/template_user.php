...
<body data-roomglobal="<?= @$id_tranksaksi ?>" data-roleglobal="<?= $_SESSION['role']=='user'?1:0 ?>"
    data-nameglobal="<?= $nama[0] ?>">
    <!-- jangan diubah -->
    ...
    <section class="body">
        ...
        <section class="body">
            ...
            let idtrx = parseInt($("body").attr("data-roomglobal"));
            let roletrx = parseInt($("body").attr("data-roleglobal"));
            let namestrx = $("body").attr("data-nameglobal");
            ...
            socket.on("notif", function(notif) {
                if (notif.id == idtrx) {
                    Swal.fire(
                        ...
                        window.location.href = `/app/chatting/${idtrx}.html`;
                    });
                }
            })
            // get message

            socket.emit("get message", idtrx);
            </script>
