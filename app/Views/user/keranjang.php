...
<?= $this->section('content'); ?>
  ...
  <?php if($cekTranksaksiByIdStatus){ ?>
    ...
    <div class="wrapper">
      <?php 
          $proses;
          if(@$cekTranksaksiByIdStatus['status_tranksaksi']=='diproses'){
            $proses='Sip, tinggal dikonfirmasi aja nih';
          }elseif (@$cekTranksaksiByIdStatus['status_tranksaksi']=='dikonfirmasi') {
            $proses='Silahkan Tunggu,Pesanan Sedang Diantarkan';
          }

      ?>
          <div class="image" id="bgImageTrx" style="background-image: url('/img/waiting.png')"></div>
          <h2 class="f-mts-ll" id="statusTrx"><?= $proses ?></h2>
          <p class="f-mts-mm">Tunggu bentar ya...</p>
        </div>
  <?php }else{ ?>
              ...
              <div class="close-pop-up-button" id="close-pop-up-button-location"></div>
                <div class="metode-pembayaran">
                    <div class="input-group mb-3">
                      <select class="custom-select pengambilan" id="inputGroupSelect01" style="height: 60px;font-size:18px">
