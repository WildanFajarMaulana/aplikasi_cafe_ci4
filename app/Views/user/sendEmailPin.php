      ...
      <!-- content -->
        <form action="" class="formUbahPinEmail"  method="post" enctype="multipart/form-data" >
          ...
          <div class="wrap-input">
            <input type="text" class="f-pps-m" id="inputEmail" name="email" placeholder="Masukkan Email Anda" readonly="" value="<?= $profilByIdLogin['email'] ?>">
          ...
          <button type="submit" class="f-pps-l btn-tambahprofile btnReset">Kirim Email</button>
        </form>
      <!-- end content -->
