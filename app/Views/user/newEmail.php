...
<?= $this->section('content'); ?>
      ...
      <!-- content -->
        <form action="/app/prosesNewEmail.html" class="formUbahEmail"  method="post" enctype="multipart/form-data" >
          <input type="hidden" class="csrfCafe" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
          <div class="wrap-input">
            <input type="text" class="f-pps-m" id="inputEmail" name="email" placeholder="Masukkan Email Anda">
            <label for="" class="f-pps-l">Masukkan Email Baru Anda</label>
          </div>
