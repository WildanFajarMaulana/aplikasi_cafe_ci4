...
<form action="/app/prosesProfile.html" class="formTambah" method="post" enctype="multipart/form-data">
    ...
    <div class="wrap-input">
        <input type="tel" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="f-pps-m" name="nomor"
    ...
    <div class="wrap-input">
        <input type="file" class="f-pps-m pt-4" name="foto" id="fotoInput" onchange="readGambar()"
            style="height: 70px;">
