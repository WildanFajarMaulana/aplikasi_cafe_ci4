...
<div class="location-user">
    <div class="left">
        <h2 class="text-location-user f-pps-m lokasi" style="margin-top:1px">Ups pilih Lokasi dulu</h2>
    </div>
    <div class="right">
        ...
        success: function(response) {
            ...
            if (response.errorSaldo) {
                ...
                window.location.href =
                    `/app/verifikasiPinTranksaksi/${response.total_pembayaran}/${response.lokasi}/${response.payment}.html`;
