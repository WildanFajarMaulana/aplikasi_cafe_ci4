...
<?= $this->section('content'); ?>
        ...
        <div class="wrapp-form ">
            <form class="formPin"  action="">
                ...
                <div>
                <input type="hidden" name="nomor" value="<?= $nomor ?>" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                <input type="hidden" name="saldo" value="<?= $saldo; ?>" onkeypress="return event.charCode >= 48 && event.charCode <=57">
